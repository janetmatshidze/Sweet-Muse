namespace NeoTemplate.IdentityServer.Initializers
{
  using System;
  using System.Linq;
  ...
  public class SeedDataAsyncInitializer : IAsyncInitializer
  {
    ...
    private readonly IOverridableUserResolver<NeoTemplateApplicationUser> userResolver;
    private readonly ISystemUserService<NeoTemplateApplicationUser> systemUserService;
    private readonly SystemUserInitializer<IdentityDbContext, NeoTemplateApplicationUser> systemUserInitializer;
    ...
    public SeedDataAsyncInitializer(
      ...
      IOverridableUserResolver<NeoTemplateApplicationUser> userResolver,
      ISystemUserService<NeoTemplateApplicationUser> systemUserService,
      SystemUserInitializer<IdentityDbContext, NeoTemplateApplicationUser> systemUserInitializer)
    {
    ...
    private async Task SeedUsersAsync(IdentityProvider identityProvider)
    {
      if (!this.identityDbContext.Users.Any(neoTemplateApplicationUser => (new[] { AliceId, BobId, SuperUserId }).Contains(neoTemplateApplicationUser.Id)))
      {
        ...
        {
          // Production
          var email = "superu@NeoTemplate.com".ToLowerInvariant();
    ...
    private async Task ConfigureDatabaseEncryptionAsync()
    {
      ...
      await this.columnEncryptionService.EncryptColumnsAsync<NeoTemplateApplicationUser>(
