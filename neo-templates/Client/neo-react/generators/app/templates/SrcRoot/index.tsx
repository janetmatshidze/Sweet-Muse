...
import '<%= srcRelativeToIndex %>/AppSetup';
import Layout from '<%= srcRelativeToIndex %>/Views/Layout';
import { AppService, Types } from '<%= srcRelativeToIndex %>/Services/AppService';
import { AuthenticationService } from '<%= srcRelativeToIndex %>/Services/AuthenticationService';
import { AppConfig } from '<%= srcRelativeToIndex %>/Models/AppConfig';
...
<%_ if(!hasModules) { _%>
        ...
        // if (!authService.ensureSignedIn(config)) {
        //     return;
        // }
<%_ } _%>
<%_ if(hasModules) { _%>
