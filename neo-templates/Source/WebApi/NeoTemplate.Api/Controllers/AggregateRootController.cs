namespace NeoTemplate.Api.Controllers
{
  ...
  [ApiController]
  public class AggregateRootController : UpdateableControllerBase<AggregateRoot, ModelDbContext, int>
  {
    /// <summary>
    ...
    public AggregateRootController(
      IUpdateableModelService<AggregateRoot, ModelDbContext, int> modelService)
