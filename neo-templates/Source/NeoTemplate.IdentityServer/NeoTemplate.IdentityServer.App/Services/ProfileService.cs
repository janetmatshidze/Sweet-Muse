namespace NeoTemplate.IdentityServer.App.Services
{
  ...
  public class ProfileService : IProfileService
  {
    ...
    {
      var user = context.User as NeoTemplateApplicationUser ??
      ...
      if (!context.IssuedClaims.HasClaimType(NeoTemplateClaimTypes.IsInvitedUser) &&
          await this.dbContext.UserInvites.AnyAsync(invite => invite.EmailAddress == user.Email))
      {
        context.IssuedClaims.Add(new Claim(NeoTemplateClaimTypes.IsInvitedUser, "true"));
      }
    }
