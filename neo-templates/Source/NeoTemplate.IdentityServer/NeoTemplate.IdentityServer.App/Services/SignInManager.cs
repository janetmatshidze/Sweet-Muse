namespace NeoTemplate.IdentityServer.App.Services
{
  ...
  /// </summary>
  public class SignInManager : SignInManager<NeoTemplateApplicationUser>
  {
    ...
    public SignInManager(
      ...
      IUserClaimsPrincipalFactory<NeoTemplateApplicationUser> claimsFactory,
      IOptions<IdentityOptions> optionsAccessor,
      ILogger<SignInManager> logger,
      IAuthenticationSchemeProvider schemes,
      IUserConfirmation<NeoTemplateApplicationUser> confirmation,
    ...
    /// </summary>
    public NeoTemplateApplicationUser? SignedInUser { get; private set; }

    /// <inheritdoc/>
    public override Task<bool> CanSignInAsync(NeoTemplateApplicationUser user)
    {
      if (!user.IsActive)
      {
    ...
    public bool MustConfigureMFA(SignInResult result, NeoTemplateApplicationUser user)
    {
    ...
    private List<ISignInRule> GetSignInRules()
    {
      List<ISignInRule> signInRules = new List<ISignInRule>()
      {
        new UnknownUserRule(),
        new BlockedUserRule(),
        new ValidPasswordRule<NeoTemplateApplicationUser>(this),
      };
      return signInRules;
    }

    private SignInCriteria InitializeSignInAuditCriteria(string userName, string password, bool isPersistent, bool lockoutOnFailure, NeoTemplateApplicationUser? user, int identityProviderId)
    {
