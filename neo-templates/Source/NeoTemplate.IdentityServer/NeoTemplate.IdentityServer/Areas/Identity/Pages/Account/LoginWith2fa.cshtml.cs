namespace NeoTemplate.IdentityServer.Areas.Identity.Pages.Account
{
  ...
  public class LoginWith2faModel : AccountPageModelBase<LoginWith2faModel>
  {
    ...
    public LoginWith2faModel(SignInManager<NeoTemplateApplicationUser> signInManager, ILogger<LoginWith2faModel> logger, IUrlProvider urlProvider, IConfiguration configuration)
