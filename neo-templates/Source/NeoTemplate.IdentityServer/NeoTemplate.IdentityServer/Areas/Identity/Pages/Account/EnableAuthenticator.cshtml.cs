...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    public async Task<IActionResult> OnGetAsync(bool tenantRequiresMFA = false, bool rememberMe = false, string? returnUrl = null)
    {
      ...
      NeoTemplateApplicationUser? user = await this.GetUserAsync();
      if (user == null)
      {
    ...
    private async Task<NeoTemplateApplicationUser?> GetUserAsync()
    {
    ...
    private async Task LoadSharedKeyAndQrCodeUriAsync(NeoTemplateApplicationUser user)
    {
