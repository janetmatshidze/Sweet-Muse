...
namespace NeoTemplate.IdentityServer.Areas.Identity.Pages.Account
{
  [AllowAnonymous]
  public class ExternalLoginModel : AccountPageModelBase<ExternalLoginModel>
  {
    private readonly SignInManager<NeoTemplateApplicationUser> signInManager;
    ...
    private readonly IIdentityProviderUserService<NeoTemplateApplicationUser> identityProviderUserService;
    private readonly ISignInAuditService signInAuditService;

    public ExternalLoginModel(
        SignInManager<NeoTemplateApplicationUser> signInManager,
        ...
        IIdentityProviderUserService<NeoTemplateApplicationUser> identityProviderUserService,
    ...
    public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
    {
      ...
      try
      {
        ...
        var newUser = new NeoTemplateApplicationUser
        {
          UserName = email,
          Email = email,
          FirstName = firstName,
    ...
    public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
    {
      ...
      if (ModelState.IsValid)
      {
        ...
        var user = new NeoTemplateApplicationUser { UserName = Input.Email, Email = Input.Email, IdentityProviderId = identityProvider.IdentityProviderId };
