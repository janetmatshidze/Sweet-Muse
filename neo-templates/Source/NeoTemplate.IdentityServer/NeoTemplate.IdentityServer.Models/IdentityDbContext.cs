namespace NeoTemplate.IdentityServer
{
  ...
  /// </summary>
  public class IdentityDbContext : IdentityDbContextBase<IdentityDbContext, Models.NeoTemplateApplicationUser>, IIdentityProvidersDbContext, ISignInAuditDbContext, IDataProtectionKeyContext
  {
    /// <summary>
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity<Models.NeoTemplateApplicationUser>(entityTypeBuilder =>
      {
