namespace NeoTemplate.IdentityServer.Tests
{
  using System;
  ...
  internal class UnitTestHelper
  {
    ...
    internal static IdentityProviderServiceCreationResult CreateIdentityProviderServices(Action<AuthenticationScheme>? addSchemeHandler = null, Action<string>? removeSchemeHandler = null)
    {
      ...
      var authenticationSchemeProvider = new FakeAuthenticationSchemeProvider(
        addSchemeHandler,
        removeSchemeHandler,
        name => name == "Google"
          ? new AuthenticationScheme("Google", "Test Google", typeof(OpenIdConnectHandler))
          : null);
      ...
      var result = new IdentityProviderServiceCreationResult(
        ...
        new IdentityProviderService<IdentityDbContext>(serviceScopeFactory, authenticationSchemeProvider, identityProviderCache, GetNeoMapper()));
