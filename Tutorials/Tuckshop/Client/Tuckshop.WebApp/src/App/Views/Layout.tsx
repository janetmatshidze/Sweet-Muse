...
export default class Layout extends React.Component {
    ...
    private routing = AppService.get(
        Types.Neo.Routing.GlobalRoutingState
    );
        ...
        return (
            <main>
                ...
                <ContainerPanel>
                                ...
                                <>
                                    ...
                                    <div
                                        className={
                                            ...
                                            (
                                                this.routing.currentViewFullScreen
                                                    ? ""
                                                    : " constrain-width"
                                            )
                                        }
                    ...
                    <Neo.ToastContainer
                        notificationStore={NotifyUtils.store}
                    />
...
class ContainerPanel extends React.Component<{
    ...
    private appLayout = AppService.get(
        Types.App.Services.AppLayout
    );
