...
namespace NeoTemplate.AuthorisationServer.Models.Migrations.Migrations
{
  using System;
  ...
  public partial class InitialMigration : Migration
  {
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            table.PrimaryKey("PK_Resources", columns => columns.ResourceId);
          });
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            table.PrimaryKey("PK_UserGroups", columns => columns.UserGroupId);
          });
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            table.PrimaryKey("PK_RoleCategories", columns => columns.RoleCategoryId);
            table.ForeignKey(
                      name: "FK_RoleCategories_Resources_ResourceId",
                      column: columns => columns.ResourceId,
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            table.PrimaryKey("PK_Memberships", columns => columns.MembershipId);
            table.ForeignKey(
                      name: "FK_Memberships_UserGroups_UserGroupId",
                      column: columns => columns.UserGroupId,
                      principalTable: "UserGroups",
                      principalColumn: "UserGroupId",
                      onDelete: ReferentialAction.Cascade);
            table.ForeignKey(
                      name: "FK_Memberships_Users_UserId",
                      column: columns => columns.UserId,
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            table.PrimaryKey("PK_Registrations", columns => columns.RegistrationId);
            table.ForeignKey(
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            table.PrimaryKey("PK_Roles", columns => columns.RoleId);
            table.ForeignKey(
                      name: "FK_Roles_RoleCategories_RoleCategoryId",
                      column: columns => columns.RoleCategoryId,
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            table.PrimaryKey("PK_AssignedRoles", columns => columns.AssignedRoleId);
            table.ForeignKey(
                      name: "FK_AssignedRoles_Roles_RoleId",
                      column: columns => columns.RoleId,
