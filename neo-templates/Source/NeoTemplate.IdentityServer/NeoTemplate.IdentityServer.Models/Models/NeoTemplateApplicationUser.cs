namespace NeoTemplate.IdentityServer.Models
{
  ...
  /// </summary>
  [ModelMetadataType(type: typeof(NeoTemplateApplicationUserMetadata))]
  [Serializable]
  public class NeoTemplateApplicationUser : ApplicationUser, IApplicationUser, IIdentityProviderUser
  {
    /// <inheritdoc />
    ...
    public static NeoTemplateApplicationUser SystemUser(Guid id)
    {
  ...
  /// </summary>
  public class NeoTemplateApplicationUserMetadata
  {
